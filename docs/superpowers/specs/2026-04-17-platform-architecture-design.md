...
- [x] Phase 5.8 — Poorten (gates) — [design](../plans/2026-04-28-phase-5.8-poorten-design.md)
  ...
  - [x] Phase 5.8.2 — Poort ProductKind + landing card + deep-link hydration — [plan](../plans/2026-04-28-phase-5.8.2-poort-products.md)
  - [x] Phase 5.8.3 — Gate SupplierProductKind + per-instance SKU/options picker — [plan](../plans/2026-04-29-phase-5.8.3-gate-supplier-products.md)
